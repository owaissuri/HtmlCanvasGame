...
var imageRepository = new function() {
  ...
  this.foreground = new Image();
	...
	// Set images src
	this.background.src = "bg1.png";
	this.foreground.src = "fg1.png";
	this.spaceship.src = "ship.png";
	this.bullet.src = "bl1.png";
	this.enemy.src = "eship.png";
	this.enemyBullet.src = "ebl.png";
}
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			this.backgroundAudio = new Audio("sj.wav");
